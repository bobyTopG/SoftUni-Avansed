namespace ClothesMagazine
{
    public class StartUp
    {
        static void Main(string[] args)
        {
            ...
            Magazine magazine = new Magazine("Zara", 20); //Initialize entity (Cloth)
            Cloth cloth1 = new Cloth("red", 36, "dress"); //Print Cloth
            Console.WriteLine(cloth1); //Product: dress with size 36, color red //Add Cloth
            magazine.AddCloth(cloth1);
            Console.WriteLine(magazine.RemoveCloth("black")); //false
            Cloth cloth2 = new Cloth("brown", 34, "t-shirt"); Cloth cloth3 = new Cloth("blue", 32, "jeans");
            //Add Cloth
